...
href="https://www.abc.com/s/pages/account.php?screen=login"><SPAN 
id=lock_img class=sprite_img></SPAN>Log In</A> <SPAN class=divider>|</SPAN> <A 
href="s/pages/ordertracking.php">Track Your Order</A> 
